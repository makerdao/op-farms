...
contract L1FarmProxy {
    ...
    uint224 public rewardThreshold; // TODO: should we still have it? we don't have to anymore since this contract doesn't hold eth to waste. If not then we rely on dss-cron's defined intervals for timing - https://github.com/makerdao/dss-cron/blob/master/src/VestRewardsDistributionJob.sol#L141. Opting for now to leave it to maintain symmetry with Arbitrum and with the L2 proxy.
